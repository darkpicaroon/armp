 ...
 */
package com.android.armp.tests.stress;
...
import com.android.armp.MusicBrowserActivity;
...
public class MusicPlaybackStress extends ActivityInstrumentationTestCase <TrackBrowserActivity>{
    ...
    public MusicPlaybackStress() {
      super("com.android.armp",TrackBrowserActivity.class);
    }
    ...
    public void testPlayAllSongs() {
      ...
      try{
        ...
        ActivityMonitor mediaPlaybackMon = inst.addMonitor("com.android.armp.MediaPlaybackActivity", 
          null, false);
