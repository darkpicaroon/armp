...
package com.android.armp.tests.functional;
...
import com.android.armp.CreatePlaylist;
import com.android.armp.MusicUtils;
import com.android.armp.PlaylistBrowserActivity;
import com.android.armp.TrackBrowserActivity;

import com.android.armp.tests.MusicPlayerNames;
import com.android.armp.tests.functional.TestSongs;
...
public class TestPlaylist extends ActivityInstrumentationTestCase <PlaylistBrowserActivity>{
    ...
    public TestPlaylist() {
        super("com.android.armp",PlaylistBrowserActivity.class);
    }
    ...
    public void addNewPlaylist(String playListName) throws Exception{
        ...
        ActivityMonitor trackBrowserMon = inst.addMonitor("com.android.armp.TrackBrowserActivity", 
                null, false);
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_PICK);
        intent.setClassName("com.android.armp", "com.android.armp.TrackBrowserActivity");
